 ...
 */
public class RenterSearchItemRVAdapter extends RecyclerView.Adapter<RenterSearchItemRVAdapter.ViewHolder> {

    private final List<SPrequest> mValues;
    private final OnRequestAcceptListener mListener;

    public RenterSearchItemRVAdapter(List<SPrequest> items, OnRequestAcceptListener listener) {
        mValues = items;
        mListener = listener;
    }
